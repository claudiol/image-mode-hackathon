...
locals {
  ...
  cop_sample_quay_repository_path = "image-mode/sample-rhel9"
...
resource "terraform_data" "deploy_cop_aap_pipeline" {
  ...
  triggers_replace = [
    ...
    local.cop_sample_quay_repository_path,
  ...
  provisioner "local-exec" {
    ...
    environment = {
      ...
      SAMPLE_QUAY_REPOSITORY_PATH = local.cop_sample_quay_repository_path
    ...
    command = <<-EOT
      ...
      echo "Quay repository path: $SAMPLE_QUAY_REPOSITORY_PATH"
